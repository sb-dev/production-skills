...
Production Skills are independent Agent Skills projects that encode reusable production expertise for domains such as narrative, music, video, advertising, graphic novels, game development, software engineering, deep research, UI/UX, legal, business building, world/environment production, 3D, characters, animation, sound, and QA/evaluation.
...
`advertising-production-skills` is planned as the advertising-production layer between approved business acquisition strategy and specialist creative execution. It owns campaign briefs, message/claim/proof architecture, creative strategy, cross-format variants, media plans, audience hypotheses, campaign experiments, measurement, creative-fatigue management and campaign optimisation while preserving boundaries with Business Building, Legal, Narrative, Video, Audio and UI/UX.

`graphic-novel-production-skills` is planned as the sequential visual storytelling layer between approved narrative and publication-ready graphic-novel editions. It owns narrative-to-page adaptation, page/panel scripting, reading order, page-turn design, visual continuity, lettering, colour/value hierarchy and print/digital packaging while preserving boundaries with Narrative, Character Performance, 3D, Video, Legal and generic image-production tooling.
...
**Consuming projects own their own specifications, research logs, capability maps, roadmaps, Production Skills selection, Extension Pack selection, and integration decisions.** A game, software product, film, legal matter, business, advertising campaign, graphic novel, or other project may depend on many Production Skills repositories without becoming part of this central repository.
...
- [`Advertising Production Skills`](docs/research-logs/2026-09-08-advertising-production-skills-new-project-bootstrap-process.md), turning approved business offers and acquisition objectives into traceable campaign briefs, claim/proof systems, creative variants, media plans, experiments and optimisation while requiring truthful claims, current platform-policy context and downstream business alignment;
- [`Graphic Novel Production Skills`](docs/research-logs/2026-09-08-graphic-novel-production-skills-new-project-bootstrap-process.md), turning approved narrative into page-and-panel storytelling, visual continuity, lettering and publication-ready print/digital editions while treating sequential-art pages as final reader-facing compositions rather than collections of generated images or storyboards;
...
- a central ad server, DSP, attribution engine or media-buying platform;
- a central illustration, page-layout or publishing platform.
